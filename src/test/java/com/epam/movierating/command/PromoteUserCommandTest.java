...
public class PromoteUserCommandTest {
    ...
    private PromoteUserCommand promoteUserCommand;
    ...
    public void setUp() {
        ...
        promoteUserCommand = new PromoteUserCommand(accountService);
    }
    ...
    public void testExecuteShouldReturnRedirectCommandResult() throws ServiceException {
        ...
        CommandResult commandResult = promoteUserCommand.execute(request);
        //then
    ...
    @Test
    public void testExecuteShouldPromoteUser() throws ServiceException {
        //given
        //when
        when(request.getParameter(Parameter.ID)).thenReturn(VALID_ID_PARAM);
        when(request.getServletContext()).thenReturn(servletContext);
        promoteUserCommand.execute(request);
        //then
        verify(accountService, times(1)).promoteUserToEditor(VALID_ID);
    }
